...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0x33CCCCCC,
	...
	private void drawValue(Canvas canvas) {
		...
		if (labelLayout != null) {
			canvas.save();
			canvas.translate(itemsLayout.getWidth() + LABEL_OFFSET, (bounds.top+bounds.bottom)/2);
		...
		if (valueLayout != null) {
			canvas.save();
			canvas.translate(0, (bounds.top+bounds.bottom)/2 + scrollingOffset);
	...
	private void drawItems(Canvas canvas) {
		...
		int top = (itemsLayout.getLineTop(0)+itemsLayout.getLineBottom(0))/2;
